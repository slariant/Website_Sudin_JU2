            ...
            <div className="container mx-auto px-6 md:px-12 lg:px-24 z-20 text-center text-white pt-20">
                ...
                >
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-full font-semibold flex items-center justify-center transition-colors shadow-lg shadow-blue-600/30"
                    >
                        Informasi Layanan
                    ...
                    <motion.button
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        className="w-full sm:w-auto bg-white/10 hover:bg-white/20 backdrop-blur-md text-white border border-white/30 px-8 py-4 rounded-full font-semibold transition-colors"
                    >
                        Program Unggulan
                    </motion.button>
                </motion.div>
